...
TOKENIZER_CACHE_DIR = os.path.join(SCRATCH_ROOT, "llama-models-cache")
...
def load_training_split() -> Dataset:
    ...
    try:
        ...
        return load_dataset("mlabonne/guanaco-llama2-1k", split="train", cache_dir="/lustre/orion/stf218/scratch/1eh/data_cache") #load_from_disk('data_cache/mlabonne___guanaco-llama2-1k/data')
        '''load_dataset(
            data_name,
            split="train",
...
# Training
fine_tuning.train()
base_model.save_pretrained("finetuned_llama3_8B")
